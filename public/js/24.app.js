    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function created$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(this.getPayroll(this.$route.params.id).then(function (res) {
            ...
            [
              _c(
                ...
                [
                  ...
                  _vm.is_saleCreatedByLoginUser == false
                    ? _c(
                        "vs-select",
                        {
                  ...
                  _vm._v(" "),
                  _vm.userType == "Supervisor" &&
                  _vm.is_saleCreatedByLoginUser == true
                    ? _c(
                        "vs-select",
                        {
                          staticClass: "p-0 ml-0",
