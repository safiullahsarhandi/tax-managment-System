...
export default {
    ...
    methods: {
        ...
        notAllowed(opt){
            ...
            var msg;
            if(opt == 'status'){
                msg = 'You cann\'t change payroll status, Payroll are approved or management reviewing ';
            }else if(opt == 'delete'){
                msg = 'You cann\'t delete payroll, Payroll are approved or management reviewing ';
            }else if(opt == 'edit'){
                msg = 'You cann\'t edit/update payroll, Payroll are approved or management reviewing ';
            }
