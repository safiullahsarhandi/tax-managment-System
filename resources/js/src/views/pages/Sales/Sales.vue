...
export default {
    ...
    methods: {
        ...
        notAllowed(opt){
            ...
            var msg;
            if(opt == 'status'){
                msg = 'You cann\'t change sale status, Sale are approved or management reviewing ';
            }else if(opt == 'delete'){
                msg = 'You cann\'t delete sale, Sale are approved or management reviewing ';
            }else if(opt == 'edit'){
                msg = 'You cann\'t edit/update sale, Sale are approved or management reviewing ';
            }
