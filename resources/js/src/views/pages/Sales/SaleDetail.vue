                    ...
                    <vs-list>
                        ...
                        <template>
                            <vs-list-item v-if="userType != 'Officer'" title="Status">
                                <vs-button icon-pack="feather" size="small" icon='icon-check-circle'></vs-button>
                                <vs-button icon-pack="feather" size="small" icon='icon-x-circle'></vs-button>
                            </vs-list-item>
                            <vs-list-item v-else title="Status">
                                <vs-switch icon-pack="feather"></vs-switch>
                            </vs-list-item>
                        </template>
