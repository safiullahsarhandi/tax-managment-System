...
export default {
    ...
    methods: {
        ...
        notAllowed(opt){
            ...
            var msg;
            if(opt == 'status'){
                msg = 'You cann\'t change purchase status, Purchase are approved or management reviewing ';
            }else if(opt == 'delete'){
                msg = 'You cann\'t delete purchase, Purchase are approved or management reviewing ';
            }else if(opt == 'edit'){
                msg = 'You cann\'t edit/update purchase, Purchase are approved or management reviewing ';
            }
