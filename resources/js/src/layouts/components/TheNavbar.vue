        ...
        <div class="vx-navbar-wrapper">
            <vs-navbar class="vx-navbar navbar-custom" :color="navbarColor" :class="classObj">
                ...
                <template v-if="breakpoint != 'md'">
                    ...
                    <div class="bookmark-container" style="width: 32%">
                        <vx-auto-suggest :autoFocus="false" :data="navbarSearchAndPinList" @selected="selected" @actionClicked="actionClicked" inputClassses="w-full" show-action show-pinned background-overlay></vx-auto-suggest>
                    </div>
                </template>
                <vs-spacer></vs-spacer>
                <!-- USER META -->
                ...
                <div class="the-navbar__user-meta flex items-center">
                    ...
                    <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
                        <div class="con-img ml-3">
                            <vs-avatar>Admin</vs-avatar>
                        </div>
                        <vs-dropdown-menu class="vx-navbar-dropdown">
                            <ul style="min-width: 14rem">
                                <li class="flex py-2 px-4 cursor-pointer hover:bg-primary hover:text-white" @click="changePasswordPopUp()">
                                    <feather-icon icon="KeyIcon" svgClasses="w-4 h-4"></feather-icon> <span class="ml-2">Change Passowrd</span>
                                </li>
